...
=======
- `themes/` oferece pacotes completos (Alacritty, Zellij, Neovim, Btop, fundos) e scripts que aplicam temas Yaru e extensões com `gsettings`.
>>>>>>> 50ffd92 (md files)
...
=======
- CLI pós-instalação via `bin/valinor` (menu Gum em `bin/valinor-sub/menu.sh`) permite trocar tema, fonte, rodar instaladores/updates, migrar ou desinstalar.
>>>>>>> 50ffd92 (md files)
